...
from FDA_Dates_API import api_recent_dates_bp
from FDA_ASK_API import api_ask_bp
from FDA_SQL_API import api_sql_bp
...
app.register_blueprint(api_recent_dates_bp, url_prefix='/recent_dates')
app.register_blueprint(api_ask_bp, url_prefix='/ask')
app.register_blueprint(api_sql_bp, url_prefix='/sql')
